<%@ page import="fsjd.course3.flyaway.model.Search"%>
<%@ page import="fsjd.course3.flyaway.model.Booking"%>
<%
...
<body>
	...
	<div class="container">
		...
		<br>
		<h2 align="right">
			<strong>Total Paid- Rs.<%=Search.persons * Booking.ticket_price%></strong>
		</h2>
		<br>
		<br>
	</div>
